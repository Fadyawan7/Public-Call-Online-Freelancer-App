...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<FreelancerBookingProvider>()),
      ChangeNotifierProvider(create: (context) => di.sl<FreelancerPortfolioProvider>()),
    ...
    return Consumer<SplashProvider>(
      builder: (context, splashProvider, child){
        ...
        return (kIsWeb && splashProvider.configModel == null) ? const SizedBox() : MaterialApp.router(
          ...
          title: splashProvider.configModel != null ? splashProvider.configModel!.companyName ?? '' : AppConstants.appName,
