...
class FreelancerBookingShimmerWidget extends StatelessWidget {
  const FreelancerBookingShimmerWidget({super.key});
        ...
        return Center(
          child: Container(
            ...
            child: Shimmer(
              ...
              enabled: Provider.of<BookingProvider>(context).runningOrderList == null,
